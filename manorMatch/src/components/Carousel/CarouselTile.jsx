...
const CarouselTile = ({ imageUrl, category, description, serviceDetails }) => {
  return (
    <div className="bg-mmblue p-6 flex flex-col justify-center items-center">
      ...
      <br />
      <p className="text-white text-center text-xs sm:text-sm md:text-lg lg:text-xl font-thin overflow-hidden overflow-ellipsis whitespace-nowrap w-11/12">{category}</p>
    </div>
  );
};
